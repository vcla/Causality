...
*** upload: 
**** runs causal_grammar.import_summerdata -- importing from CVPR2012_reverse_slidinwindow_action_detection_logspace)
...
'ANALYSIS
* analyze_results.go by Mingtian reads cvpr_db_results.csv; what does it do? TODO
